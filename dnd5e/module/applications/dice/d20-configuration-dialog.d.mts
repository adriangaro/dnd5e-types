...
declare namespace D20RollConfigurationDialog {
  ...
  >
  interface RenderContext extends dnd5e.types.PrettifyType<D20RollConfigurationDialog['__RenderContext']> {}
  ...
  >
  interface Configuration extends dnd5e.types.PrettifyType<D20RollConfigurationDialog['__Configuration']> {}
  ...
  >
  interface RenderOptions extends dnd5e.types.PrettifyType<D20RollConfigurationDialog['__RenderOptions']> {}
}
