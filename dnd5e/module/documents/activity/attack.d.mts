...
declare class AttackActivity extends ActivityMixin(AttackActivityData) {
   ...
   */
  rollAttack(config={}, dialog={}, message={}): Promise<dnd5e.dice.D20Roll[] | null> {
...
declare namespace AttackActivity {
 interface AttackRollProcessConfiguration extends dnd5e.types.D20RollProcessConfiguration {
