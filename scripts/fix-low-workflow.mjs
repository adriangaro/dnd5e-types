...
FINDINGS: read reviews/fix-targets-LOW.json (JSON keyed by file path) and take the array at key "${f}". Each entry: { severity, axis, member, detail, fix, note }.
